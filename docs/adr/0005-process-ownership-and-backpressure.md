...
`graphene-platform` owns private direct-process spawn/probe primitives. `graphene-java` uses them
for bounded Java probing. `graphene-launch` owns the public Minecraft lifecycle abstraction
